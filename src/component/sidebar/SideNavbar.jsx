            ...
            <div className=" md:block w-full min-h-screen p-3 space-y-2  bg-gray-300 text-gray-800">
                ...
                <div className="divide-y divide-gray-300">
                    ...
                    <ul className="pt-4 pb-2 space-y-1 text-sm">
                        ...
                        <li>
                            {
                                role == 'admin' ?
                                    <NavLink to={'/settings'}>
                                        <p rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md transform hover:scale-105 duration-500">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-600">
                        ...
                        <li>
                            <a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md transform hover:scale-105 duration-500">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-600">
