...
const EditBtn = ({ data }) => {
    ...
    return (
        <div>
            ...
            <button className="btn btn-sm  btn-success text-white" onClick={() => document.getElementById('my_modal_3').showModal()}>Edit</button>
            <dialog id="my_modal_3" className="modal ">
                <div className=" modal-scroll modal-box max-w-4xl w-full h-full  ">
                    <form method="dialog">
                        {/* if there is a button in form, it will close the modal */}
                        <button className="flex btn  btn-sm btn-circle btn-ghost absolute right-2 top-2"><span className="bg-red-500 p-2 text-white rounded-full">✕ </span>close</button>
                    </form>
                    {/* main container */}
                    <section>
