...
const LoanClosingAccountRequest = () => {
    return (
        <div>
            <section>
                <LoanManagementNav />
            ...
            <section>
                <section className="m-4">
                    <h1 className="text-xl font-bold text-start max-w-5xl mx-auto  pt-4 border-b-4 pb-2 ">Loan Closing Account Request</h1>
                    <form className="my-8" >
...
export default LoanClosingAccountRequest;