        ...
        <section className="p-4 max-w-4xl mx-auto bg-gray-100 md:mt-8 rounded ">
            <div className="flex flex-col md:flex-row gap-4 border-b-4 pb-4">
                <div className="md:w-1/2">
                    <img className=" rounded object-cover " src={photo} alt="" />
                </div>
                <div className="md:w-1/2 space-y-2 p-4 ">
                    <h1 className="md:text-4xl">{name}</h1>
                    <p className="font-bold text-green-600">{status}</p>
                    <p className="text-lg font-medium">Phone Number: <span className=" pl-2 font-normal">{mobileNumber}</span></p>
                    <p className="text-lg font-medium"> NID :<span className="font-normal pl-2">{nidNumber}</span></p>
                </div>
            </div>
