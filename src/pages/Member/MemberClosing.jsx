        ...
        <form className="my-8" action="">
          <section className=" grid grid-cols-2 max-w-5xl mx-auto gap-4 ">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input className="border-2 hover:border-black rounded " id="member_id" type="text"/>
            </div>

            <div className="flex flex-col gap-1">
              <label className="font-medium" htmlFor="closing_date">Closing Date:</label>
              <input className="border-2 hover:border-black rounded " id="closing_date" type="date" />
            </div>

            <div className="flex flex-col gap-1 col-span-2">
              <label className="font-medium" htmlFor="closing_reason">Closing Reason:</label>
              <textarea id="closing_reason" cols="10" rows="2" className="border-2 hover:border-black rounded "></textarea>
            </div>
          </section>

          {/* Submit button */}
          
          <div className="w-full flex  pl-3 mt-12 justify-center">
