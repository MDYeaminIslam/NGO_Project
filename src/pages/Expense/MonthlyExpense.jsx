        ...
        <form className="my-8" action="">
          <section className="grid grid-cols-3 max-w-5xl mx-auto gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input className="input input-bordered input-sm  hover:border-teal-500  "id="date" 
              name = "date"
              onChange={handleChange}
              type="date" 
              placeholder="" />
            ...
            <div className="flex flex-col gap-1">
              ...
              <input className="input input-bordered input-sm  hover:border-teal-500  "id="office_rent"
              name = "officeRent"
              onChange={handleChange} 
              type="number" 
              placeholder="Tk" />
            ...
            <div className="flex flex-col gap-1">
              ...
              <input className="input input-bordered input-sm  hover:border-teal-500  "id="salary"
              name = "salary" 
              onChange={handleChange}
              type="number" 
              placeholder="Tk" />
